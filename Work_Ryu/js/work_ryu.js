...
window.addEventListener('DOMContentLoaded', function () {
    ...
    const ASSETS = {
        heart: {
            active: './Work_Ryu/asset/icon_heart_active.svg',
            inactive: './Work_Ryu/asset/icon_heart_unactive.svg'
        },
        profileBg: [
            './Work_Ryu/asset/icon_bg_green.svg',
            './Work_Ryu/asset/icon_bg_purple.svg',
    ...
    function generateComments(count, maxReplies = 20, useRecentTime = false) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            const chaRandom = random.item(ASSETS.character);
